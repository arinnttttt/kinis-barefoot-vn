  ...
  return (
    <section className="why-kinis-section py-16 sm:py-20 lg:py-24 px-4 sm:px-6" style={{ backgroundColor: "hsl(0, 0%, 96%)", isolation: "isolate" }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-stretch gap-5 sm:gap-6 lg:gap-2">
          ...
          <div className="relative lg:w-[62%]" style={{ minHeight: "220px" }}>
            <div className="diagonal-skew-card rounded-2xl sm:rounded-2xl overflow-visible relative pb-36 sm:pb-0" style={{ backgroundColor: "#f97316" }}>
              ...
              <img
                ...
                className="hidden sm:block absolute sm:-right-6 lg:-right-4 xl:-right-6 top-1/2 h-[125%] sm:h-[130%] lg:h-[138%] xl:h-[148%] max-h-[300px] sm:max-h-[320px] lg:max-h-[340px] xl:max-h-[374px] object-contain pointer-events-none"
