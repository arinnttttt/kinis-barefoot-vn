        ...
        <div className="flex flex-col lg:flex-row lg:items-stretch gap-4 lg:gap-2">
          ...
          <div className="diagonal-skew-card rounded-2xl overflow-visible lg:w-[34%] relative" style={{ backgroundColor: "#1a1a1a" }}>
            ...
            <img
              ...
              className="apma-seal-stamp absolute -top-3 sm:-top-5 left-2 sm:-left-5 w-[4.5rem] h-[4.5rem] sm:w-24 sm:h-24 object-contain z-10 sm:[transform:skewX(5deg)_rotate(-8deg)] rotate-[-8deg]"
              loading="lazy"
            />
