...
const benefits = [
  {
    ...
    description:
      "Công nghệ hỗ trợ vòm chân 3 điểm phân bổ áp lực đều, giảm đau và mỏi khi đứng lâu hoặc di chuyển nhiều.",
  },
  {
    icon: Compass,
    title: "Cải thiện dáng đi tự nhiên",
    description:
      "Thiết kế ergonomic giúp cơ thể căn chỉnh tư thế đứng và di chuyển đúng sinh cơ học.",
  },
  {
    icon: Radio,
    title: "Giảm chấn động hiệu quả",
    description:
      "Lớp đệm EVA cao cấp hấp thụ lực chấn động, bảo vệ khớp gối và cột sống khi vận động.",
  },
];
  ...
  <Layout>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10 animate-fade-up">
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-foreground">
            Tại sao bạn cần <span style={{ color: "hsl(160,60%,40%)" }}>Kinis Lucy</span>?
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 mb-10 sm:mb-12">
          {benefits.map((b, i) => (
            ...
            >
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-5" style={{ backgroundColor: "hsl(160 60% 40% / 0.1)" }}>
                <b.icon className="w-6 h-6" style={{ color: "hsl(160,60%,40%)" }} />
              </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="flex items-center justify-center animate-fade-up">
            <img
              src={lucyImage}
              alt="Kinis Lucy Technology"
              className="w-full max-w-md object-contain"
            />
          </div>

          <div className="animate-fade-up [animation-delay:150ms]">
            <span className="inline-block text-xs sm:text-sm font-body font-semibold uppercase tracking-wider mb-3" style={{ color: "hsl(160,60%,40%)" }}>
              Công nghệ
            </span>
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight leading-tight text-foreground">
              Chất liệu
              <br />
              <span style={{ color: "hsl(160,60%,40%)" }}>cao cấp</span>
            </h2>
            <p className="mt-4 text-base sm:text-lg leading-relaxed text-muted-foreground">
            ...
            <div className="mt-8 sm:mt-10 space-y-4">
              {[
                ...
                >
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "hsl(160 60% 40% / 0.1)" }}>
                    <item.icon className="w-5 h-5" style={{ color: "hsl(160,60%,40%)" }} />
                  </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10 animate-fade-up">
          ...
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-white">
            Kinis Lucy giúp bàn chân khỏe hơn
          </h2>
            ...
            {[
              {
                ...
                time: "Tuần 1",
                subtitle: "Làm quen",
                tasks: ["Sử dụng 2–3 giờ mỗi ngày", "Để bàn chân quen với lớp hỗ trợ mới"],
              },
              {
                num: "2",
                time: "Tuần 2 – 3",
                subtitle: "Thích nghi",
                tasks: ["Tăng dần thời gian sử dụng", "Bắt đầu sử dụng khi tập luyện nhẹ"],
              },
              {
                num: "3",
                time: "Sau 1 tháng",
                subtitle: "Hoàn thiện",
                tasks: ["Sử dụng cả ngày thoải mái", "Cảm nhận sự cải thiện rõ rệt về dáng đi"],
              },
            ].map((stage, i) => (
              <div
                key={stage.num}
              ...
              >
                <div className="relative select-none mb-5" style={{ height: "clamp(5rem, 10vw, 8rem)" }}>
                  ...
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: "0 0 8px hsla(160,60%,40%,0.4)",
                    }}
                  />
                </div>
                ...
                <p className="text-sm sm:text-base font-semibold mb-4" style={{ color: "hsl(160,60%,50%)" }}>
                  {stage.subtitle}
                </p>
                <ul className="space-y-3 text-left">
                  {stage.tasks.map((t) => (
                    <li key={t} className="flex items-start gap-2.5">
                      <Check className="w-4.5 h-4.5 mt-0.5 flex-shrink-0" style={{ color: "hsl(160,60%,40%)" }} />
    ...
    <section className="py-10 sm:py-14 lg:py-16 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: "hsl(0,0%,98%)" }}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10 animate-fade-up">
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-foreground">
            Đối tượng <span style={{ color: "hsl(160,60%,40%)" }}>phù hợp</span>
          </h2>
        </div>
    ...
    {/* Testimonial Section */}
    <TestimonialSection page="lucy" title={<>Mọi người nghĩ gì về <span style={{ color: "hsl(160,60%,40%)" }}>Kinis Lucy</span></>} subtitle={null} />
    ...
    <section className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: "hsl(0,0%,5%)" }}>
      <div className="max-w-3xl mx-auto text-center animate-fade-up">
        <div className="mb-3" style={{ color: "hsl(160,60%,40%)" }}>
        ...
        <p className="font-display text-xl sm:text-2xl md:text-3xl font-bold leading-snug text-white mb-3">
          Kinis Lucy không chỉ là một miếng lót giày.
        </p>
        <p className="text-base sm:text-lg leading-relaxed mb-10" style={{ color: "hsl(0,0%,60%)" }}>
          Đó là giải pháp chăm sóc sức khỏe bàn chân được chứng nhận bởi Hiệp hội Y khoa Bàn chân Hoa Kỳ (APMA).
        </p>
        <a
          href="https://byebeoshop.com/san-pham-2/"
          target="_blank"
        ...
        >
          <div className="flex items-start gap-4 mb-6">
            <div
              ...
              style={{ backgroundColor: "hsl(160,60%,40%)", color: "#fff" }}
            >
              <AlertTriangle className="w-5 h-5" />
            </div>
            <div>
              <h2 className="font-display text-xl sm:text-2xl font-bold" style={{ color: "hsl(160 50% 25%)" }}>
                Lưu ý – Hướng dẫn sử dụng
              </h2>
              <p className="text-sm sm:text-base mt-1" style={{ color: "hsl(160 30% 40%)" }}>
                Để đạt hiệu quả tốt nhất khi sử dụng Kinis Lucy, vui lòng lưu ý:
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            {[
              ...
              <div
                ...
                style={{ backgroundColor: "hsl(160 50% 92%)" }}
              >
                <Check className="w-5 h-5 flex-shrink-0" style={{ color: "hsl(160,60%,40%)" }} />
                <span className="text-sm sm:text-base font-medium" style={{ color: "hsl(160 40% 25%)" }}>{item.text}</span>
              </div>
            ))}
          </div>
        </div>
