...
const lucyShowcase = "https://kinis.vn/wp-content/uploads/2026/05/lucy-showcase-v3.png";
const nomadShowcase = "https://kinis.vn/wp-content/uploads/2026/05/nomad-showcase-v2.jpg";
...
const Index = () => {
  ...
  return (
    <Layout>
      ...
      <section className="py-10 sm:py-14 lg:py-16 px-4 sm:px-16 lg:px-6" style={{ backgroundColor: "hsl(0,0%,98%)", isolation: "isolate" }}>
        <div className="max-w-7xl mx-auto">
